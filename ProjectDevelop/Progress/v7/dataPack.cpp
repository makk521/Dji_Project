...
int main(){
    ...
    std::cout << "PackType: " << ma.getPackType() << std::endl;
    std::cout << "Channel: " << ma.getChannel() << std::endl;
    std::cout << "PacketPriority: " << ma.getPacketPriority() << std::endl;
    std::cout << "ModuleId: " << ma.getModuleId() << std::endl;
    std::cout << "PackLength: " << ma.getPackLength() << std::endl;
    std::cout << "PackOffset: " << ma.getPackOffset() << std::endl;
    std::cout << "PackSequenceNum: " << ma.getPackSequenceNum() << std::endl;
    std::cout << "DataSheetIdentificationNum: " << ma.getDataSheetIdentificationNum() << std::endl;
    std::cout << "TargetId: " << ma.getTargetId() << std::endl;
    std::cout << "SourceId: " << ma.getSourceId() << std::endl;
    std::cout << "NextHopId: " << ma.getNextHopId() << std::endl;
    std::cout << "SingleHopSourceId: " << ma.getSingleHopSourceId() << std::endl;
    std::cout << "CheckSum: " << ma.getCheckSum() << std::endl;
    std::cout << "ValidTime: " << ma.getValidTime() << std::endl;
    std::cout << "ClusterId: " << ma.getClusterId() << std::endl;

    ma.setPackType(0b111111);
    ma.setChannel(0b111);
    ma.setPacketPriority(0b111111);
    std::cout << "PackType: " << ma.getPackType() << std::endl;
    std::cout << "Channel: " << ma.getChannel() << std::endl;
    return 0;
}